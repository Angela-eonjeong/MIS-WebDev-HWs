...
namespace Kim_Angela_Eonjeong_HW3
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:sp22kimangelaeonjeonghw3.database.windows.net,1433;" +
                "Initial Catalog=sp22KimAngelaEonjeonghw3;Persist Security Info=False;" +
                "User ID=MISAdmin;Password=Password1234;MultipleActiveResultSets=False;" +
