...
namespace Kim_Angela_Eonjeong_HW5
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:sp22kimangelaeonjeonghw5.database.windows.net,1433;Initial Catalog=sp22KimAngelaEonjeonghw5;Persist Security Info=False;User ID=MISAdmin;Password=Password1234;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
